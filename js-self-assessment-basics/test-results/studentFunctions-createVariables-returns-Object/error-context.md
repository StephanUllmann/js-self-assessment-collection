...
- Name: createVariables() >> returns Object
- Location: /home/stephan/coding/wbs/self-assessment/js-basics/tests/studentFunctions.test.js:36:7
...
Expected: not {"myArray": ["cR3aTe s0Me v@r1aBl3s", 42.0000000000024, 2025-05-13T09:00:17.568Z]}

    at /home/stephan/coding/wbs/self-assessment/js-basics/tests/studentFunctions.test.js:38:26
```
...
>  38 |     expect(myObject).not.toEqual(mO);
  ...
  133 | });
  134 |
  135 | test.describe('countTypes()', () => {
  136 |   test.skip(countTypes() === 'NOT IMPLEMENTED', 'countTypes() is not implemented');
  137 |   const cases = [
  138 |     [
```